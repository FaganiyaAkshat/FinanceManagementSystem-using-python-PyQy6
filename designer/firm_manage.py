...
"}")
        ...
        self.pushButton.setMaximumSize(QtCore.QSize(16777215, 55))
...
"background-color:#9A79BA;")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("image/change_rate.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"background-color:#9A79BA;")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("image/user_report.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"background-color:#9A79BA;")
        ...
        self.pushButton_5.setMaximumSize(QtCore.QSize(16777215, 55))
...
"background-color:#9A79BA;")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("image/dev_info.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pushButton_6.setMaximumSize(QtCore.QSize(16777215, 55))
...
"background-color:#9A79BA;")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("image/how_to_use.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
